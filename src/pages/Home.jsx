      ...
      <section className="section">
        <div className="container">
          ...
          <div className="scroll-x">
            {[
              { title: 'Yo\'i Academy', img: 'https://images.unsplash.com/photo-1516321318423-f06f85e504b3?auto=format&fit=crop&q=80&w=600', link: '/learning', desc: 'Pendidikan isyarat digital & teknologi.' },
              { title: 'Yo\'i Career', img: 'https://images.unsplash.com/photo-1521737711867-e3b97375f902?auto=format&fit=crop&q=80&w=600', link: '/lowongan', desc: 'Akses pekerjaan inklusif & bimbingan.' },
              { title: 'Yo\'i Lab', img: 'https://images.unsplash.com/photo-1581091226825-a6a2a5aee158?auto=format&fit=crop&q=80&w=600', link: '/inovasi', desc: 'Riset alat bantu & inovasi AI.' },
            ].map((p, i) => (
              <Link key={i} to={p.link} style={{ textDecoration: 'none' }}>
                <motion.div 
                  whileHover={{ y: -10 }}
                  className="glass-card" 
                  style={{ padding: '0.8rem', borderRadius: '32px', overflow: 'hidden', height: '100%', display: 'flex', flexDirection: 'column' }}
                >
                  <div style={{ height: '200px', borderRadius: '24px', overflow: 'hidden', marginBottom: '1.5rem' }}>
                  ...
                  <div style={{ padding: '0.5rem 1rem 1.5rem', flex: 1, display: 'flex', flexDirection: 'column' }}>
                    <h3 style={{ fontSize: '1.4rem', fontWeight: '800', marginBottom: '0.6rem', color: 'var(--text-main)' }}>{p.title}</h3>
                    <p style={{ fontSize: '0.9rem', color: 'var(--text-muted)', marginBottom: '1.5rem', flex: 1 }}>{p.desc}</p>
